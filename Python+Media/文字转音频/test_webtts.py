...
from xfyun_config import ensure_audio_dir, load_webapi_credentials
#  合成webapi接口地址
...
def main():
    ...
    if contentType == "audio/mpeg":
        ...
        if AUE == "raw":
            print(r.content)
            writeFile(audio_dir / f"{sid}.wav", r.content)
        else:
            print(r.content)
            writeFile(audio_dir / "xiaoyan.mp3", r.content)
